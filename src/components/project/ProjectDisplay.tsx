...
import { useProjectDelete } from '@/features/project-management';
...
export function ProjectDisplay({
    ...
    const { mutate: mutateDelete, isError, message: errorMessage, data: dataDelete } = useProjectDelete();
    ...
    const handleAlertButtonOperation = () => {
        ...
        console.log("🚀 ~ file: ProjectDisplay.tsx:59 ~ handleAlertButtonOperation ~ currentSelectedOperation:", currentSelectedOperation)
    ...
    const handleConfirmDelete = () => {
        console.log("Deleting project with ID:", currentSelectedData?.id);
