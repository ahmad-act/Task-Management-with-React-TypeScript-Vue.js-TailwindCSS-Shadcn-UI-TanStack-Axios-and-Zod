...
import { useTaskDelete } from '@/features/task-management';
...
export function TaskDisplay({
    ...
    const { mutate: mutateDelete, isError, message: errorMessage, data: dataDelete } = useTaskDelete();
    ...
    const handleAlertButtonOperation = () => {
        ...
        console.log("🚀 ~ file: TaskDisplay.tsx:59 ~ handleAlertButtonOperation ~ currentSelectedOperation:", currentSelectedOperation)
    ...
    const handleConfirmDelete = () => {
        console.log("Deleting task with ID:", currentSelectedData?.id);
